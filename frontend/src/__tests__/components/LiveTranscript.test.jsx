...
describe('LiveTranscript', () => {
  ...
  it('applies text-neutral-600 to final chunks and text-neutral-400 to non-final', () => {
    const chunks = [
    ...
    expect(finalEl.className).toContain('text-neutral-600');
    expect(pendingEl.className).toContain('text-neutral-400');
  });
